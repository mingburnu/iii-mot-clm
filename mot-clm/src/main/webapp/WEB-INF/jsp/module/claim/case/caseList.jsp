...
<body class="page-padding">
	<fieldset>
		...
		<div class="divMark1">
			<%-- 搜尋區塊 --%>
			<s:form action="claim.case.list" namespace="/crud" method="post"
				cssClass="form-search">
				<table class="form-table">
					<tr>
						<td class="form-label"><s:select name="selectKey"
								cssClass="input-medium"
								list="#{'entity.caseCode':'賠案編號','entity.accidentPeopleId':'事故人ID','entity.code':'報案編號','entity.insuredId':'被保險人ID','entity.policyCode':'保單號碼','entity.plate':'車牌號碼','entity.driver':'駕駛ID'}"
		...
		<table style="width: 100%">
			<tr>
				<td><jsp:include page="/WEB-INF/jsp/layout/pagination.jsp">
						...
						<jsp:param name="action" value="claim.case.list" />
