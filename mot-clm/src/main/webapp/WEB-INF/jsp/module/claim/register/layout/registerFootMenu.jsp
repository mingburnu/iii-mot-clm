...
<ul class="nav nav-pills">
	...
	<li><a href="<s:property value='#contact' escape='false'/>">報案通訊錄</a></li>
	...
	<li><a href="<s:property value="#remark" escape="false" />">報案處理記錄</a></li>
	...
	<c:choose>
		<c:when test="${empty entity.caseCode}">
			<li><s:url namespace="/web" action="claim.register.convert"
					var="convert">
					<s:param name="entity.id">${entity.id}</s:param>
				</s:url> <a href="<s:property value="#convert" />">建立賠案</a></li>
		</c:when>
	</c:choose>
</ul>