...
<script type="text/javascript">
$(function(){
	var url= '<s:url namespace="/json" action="claim.register.findUserAjax" />';
		  ...
		  "ajax": url,
	        ...
	        "fnDrawCallback": function( oSettings ) {
	    		$('#example tbody').find('tr').each(function () {
	    			...
	    			if(typeof parent.checkUserData == 'function') {
	    				var result=parent.checkUserData(code);
	    				if(result){
	    					$(this).remove();
	    				}
	    			}
	 ...
	 $('#button1').on('click',function(){
		 if(clicked != null){
			 ...
			 parent.setUserData(code,name,office);	
		 }
