package org.iii.module.claim.cases.entity;
...
public class Case extends GenericEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8365581991155777663L;
	...
	/** 理賠人員  */
	@Column(name="CLAIM_STAFF")
	private String claimStaff;
	
	/** 理賠人員  entity */
	@Transient
	private SecUser claimStaffUser;
	
	/** 法務人員  */
	@Column(name="LAW_STAFF")
	private String lawStaff;
	
	/** 代理法務人員  */
	@Column(name="PROXY_LAW_STAFF")
	private String proxyLawStaff;
	
	/** 共保  */
	@Column(name="COINSURANCE")
	private boolean coinsurance;
	...
	public String getLawStaff() {
		return lawStaff;
	}

	public void setLawStaff(String lawStaff) {
		this.lawStaff = lawStaff;
	}

	public String getProxyLawStaff() {
		return proxyLawStaff;
	}

	public void setProxyLawStaff(String proxyLawStaff) {
		this.proxyLawStaff = proxyLawStaff;
	}
	...
	public void setCoinsurance(boolean coinsurance) {
	...
	public void setStakeholders(boolean stakeholders) {
	...
	public void setClaimStaff(String claimStaff) {
		this.claimStaff = claimStaff;
	}

	public SecUser getClaimStaffUser() {
		return claimStaffUser;
	}

	public void setClaimStaffUser(SecUser claimStaffUser) {
		this.claimStaffUser = claimStaffUser;
	}
